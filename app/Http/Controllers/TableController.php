...
class TableController extends Controller
{
    public function view()
    {
        ...
        $riwayat_tanam = DB::table('riwayat_tanam')->join('lahan', 'riwayat_tanam.id_lahan', '=', 'lahan.id_lahan')
                                                    ...
                                                    ->get();
        return view('Contents.table',['petani'=>$petani, 'pupuk' => $pupuk, 'bibit' => $bibit, 'desa' => $desa, 'lokasi' => $lokasi, 'lahan' => $lahan, 'riwayat_pembelian_pupuk' => $riwayat_pembelian_pupuk, 'riwayat_tanam' => $riwayat_tanam]);
    }
