                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{$val->id_pupuk }}">Edit</a>
                                                |
                                                <a href="{{$val->id_pupuk }}">Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{$val->id_bibit }}">Edit</a>
                                                    |
                                                    <a href="{{$val->id_bibit }}">Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$val->nama_desa}}</td>
                                                <td>
                                                    <a href="{{$val->id_desa }}">Edit</a>
                                                    |
                                                    <a href="{{$val->id_desa }}">Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$val->nama_desa}}</td>
                                                <td>
                                                    <a href="{{$val->id_lokasi }}">Edit</a>
                                                    |
                                                    <a href="{{$val->id_lokasi }}">Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                    </tbody>
                                    ...
                                    <tbody>
                                        ...
                                        $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$val->luas}}</td>
                                                <td>
                                                    <a href="{{$val->id_lahan }}">Edit</a>
                                                    |
                                                    <a href="{{$val->id_lahan }}">Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                    </tbody>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{$val->id_transaksi }}">Edit</a>
                                                |
                                                <a href="{{$val->id_transaksi }}">Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                ...
                                <table class="table">
                                    <thead class="text-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{$val->id_riwayat_tanam }}">Edit</a>
                                                |
                                                <a href="{{$val->id_riwayat_tanam }}">Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </thead>
